...
export default function useChartResizer(props) {
    ...
    useEffect(() => {
        ...
        const legendFontSize = legendStyle.fontSize && legendStyle.fontSize.name ? legendStyle.fontSize.name : '13px';
        ...
        if (!chart.isStatic) {
            ...
            const isChangeCoordinateAxis = !_.isEqual(props.coordinateAxis, previousCoordinateAxis);
